...
def classificar(texto):
    ...
    # Seguranca: se o texto tiver "nao" e a acao for CONFIRMAR, corrige para CANCELAR
    # Ex: "nao, ok" ou "nao nao quero" nao deve confirmar
    t_norm = normalizar(texto)
    if action == "CONFIRMAR" and contem(t_norm, "nao"):
        action = "CANCELAR"
